...
+ (void)trackInternalWithAppID:(NSString *)a_appID
{
    ...
    {	
        ...
        {
            // Greystripe has successfully been informed of the download. Write out
            // a dummy file to the filesystem so that we no longer inform 
            // Greystripe when this function is called.
...
+ (void)trackWithAppID:(NSString *)a_appID
{
    ...
    {
        [[GSDownloadTracker class] performSelectorInBackground:@selector(trackInternalWithAppID:) withObject:a_appID];
    }
}
